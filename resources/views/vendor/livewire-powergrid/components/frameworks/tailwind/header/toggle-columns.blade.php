@if (data_get($setUp, 'header.toggleColumns'))
    ...
    >
        ...
        <div
            ...
            class="toggle-columns-base group absolute z-10 mt-2 w-56 rounded-md dark:bg-pg-primary-700 bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-hidden"
            tabindex="-1"
